<html>
    ...
    <body>
        <table width="100%">
            ...
            <tr>
                <td class="thd" colspan="2">DESK AUDIT PROGRAM</td>
            </tr>
        </table><br>
        <table width="100%">
            <tr>
        ...
        <table width="100%">
            ...
            @foreach(deskaudit_program($data->id) as $no=>$desk)
                <tr>
                    <td class="ttd">{{$no+1}}</td>
                    <td class="ttd">{!! $desk->name !!}</td>
                    <td class="ttd">
                        @foreach(deskaudit_catatan($desk->id) as $x=>$cat)
                            <table width="100%">
                                <tr>
                    ...
                    <td class="ttd">{{$data->tgl_deskaudit_program_start}}</td>
