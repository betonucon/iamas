					...
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="javascript:;"  class="nav-link active">
								<span class="d-sm-none">DESKAUDIT PROGRAM</span>
								<span class="d-sm-block d-none">DESKAUDIT PROGRAM</span>
							</a>
						</li>
					</ul>
	...
	<script>
		...
		function ubah_data(){
            var form=document.getElementById('ubah-data');
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{url('/Deskaudit/proses_approve_pengawas')}}",
                    ...
                    success: function(msg){
                        if(msg=='ok'){
                            location.assign("{{url('/Deskauditpengawas')}}");
