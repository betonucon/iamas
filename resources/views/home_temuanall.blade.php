...
@section('contex')
			...
			<div class="row">
				@foreach(headtemuan_auditee_get_kode($kode,$tahun) as $det)
								...
								<div class="row">
									...
									<div class="col-xl-6 col-lg-12">
										...
										<div class="d-flex align-items-center m-b-2">
											<div class="flex-grow-1">
												<div class="progress progress-xs rounded-corner bg-white-transparent-1">
													<div class="progress-bar  bg-red" data-animation="width" data-value="{{round(total_temuan_nol_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber)))}}%" style="width: {{total_temuan_nol_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}%" style="width: {{total_temuan_nol_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}%"></div>
												</div>
											</div>
											<div class="ml-2 f-s-11 width-30 text-center"><span data-animation="number" data-value="{{round(total_temuan_nol_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber)))}}" style="width: {{total_temuan_nol_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}">{{total_temuan_nol_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}</span>%</div>
										</div>
										...
										<div class="d-flex align-items-center m-b-2">
											<div class="flex-grow-1">
												<div class="progress progress-xs rounded-corner bg-white-transparent-1">
													<div class="progress-bar  bg-yellow" data-animation="width" data-value="{{round(total_temuan_progres_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber)))}}%" style="width: {{total_temuan_progres_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}%" style="width: {{total_temuan_progres_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}%"></div>
												</div>
											</div>
											<div class="ml-2 f-s-11 width-30 text-center"><span data-animation="number" data-value="{{round(total_temuan_progres_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber)))}}" style="width: {{total_temuan_progres_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}">{{total_temuan_progres_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}</span>%</div>
										</div>
										...
										<div class="d-flex align-items-center m-b-2">
											<div class="flex-grow-1">
												<div class="progress progress-xs rounded-corner bg-white-transparent-1">
													<div class="progress-bar  bg-green" data-animation="width" data-value="{{round(total_temuan_selesai_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber)))}}%" style="width: {{total_temuan_selesai_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}%;"></div>
												</div>
											</div>
											<div class="ml-2 f-s-11 width-30 text-center"><span data-animation="number" data-value="{{round(total_temuan_selesai_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber)))}}">{{total_temuan_selesai_kode($kode,$tahun,$det->kode_sumber)*(100/total_temuan_kode($kode,$tahun,$det->kode_sumber))}}</span>%</div>
										</div>
											...
											<table class="table table-valign-middle table-panel mb-0">
												<tbody>
													...
													<tr>
														...
														<td class="ttdd">{{total_temuan_kode($kode,$tahun,$det->kode_sumber)}}</td>
													</tr>
													<tr>
														<td class="ttdd">Belum TL</td>
														<td class="ttdd">:</td>
														<td class="ttdd">{{total_temuan_nol_kode($kode,$tahun,$det->kode_sumber)}}</td>
													</tr>
													<tr>
														<td class="ttdd">Progres</td>
														<td class="ttdd">:</td>
														<td class="ttdd">{{total_temuan_progres_kode($kode,$tahun,$det->kode_sumber)}}</td>
													</tr>
													<tr>
														<td class="ttdd">Selesai</td>
														<td class="ttdd">:</td>
														<td class="ttdd">{{total_temuan_selesai_kode($kode,$tahun,$det->kode_sumber)}}</td>
													</tr>
													<tr>
														<td class="ttdd">Indikator</td>
														<td class="ttdd">:</td>
														<td class="ttdd">
															@if(total_temuan_kode($kode,$tahun,$det->kode_sumber)==total_temuan_selesai_kode($kode,$tahun,$det->kode_sumber))
