			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-1">
				...
				<div class="panel-body">
					...
					@if(Auth::user()->role_id==5)
						@if($data->sts==2)
							<span class="btn btn-blue btn-sm" onclick="approve_acc({{$data->id}},`RCD`)"><i class="fas fa-paper-plane"></i> Kirim ke Tim</span>
						@endif
							<span class="btn btn-green btn-sm" onclick="kembali(`rcd`)"><i class="fas fa-reply"></i> Kembali</span>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="kirim-datahead" method="post" enctype="multipart/form-data">
							...
							<div class="form-grup" id="alasan">
								<label>Catatan</label>
								<textarea class="form-control" placeholder="Ketik......" rows="5" name="alasan"></textarea>
							</div>
						</form>
