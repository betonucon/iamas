				...
				<div class="panel-body">
					...
					<div class="btn-group btn-group-justified" style="margin-bottom:2%">
						...
						@if(akses_tiket_ketua()>0)
							@if($data->sts==3)
								<span class="btn btn-blue btn-sm" onclick="approve_acc({{$data->id}},`Ketua`)"><i class="fas fa-paper-plane"></i> Kirim ke Tim</span>
							@endif
								<span class="btn btn-green btn-sm" onclick="kembali(`ketua`)"><i class="fas fa-reply"></i> Kembali</span>
