										...
										<div class="col-xl-10 offset-xl-1">
											<div class="form-group row m-b-10" >
												...
												<select class="form-control" name="kode_laporan" >
													...
													<option value="{{$kodifikasilaporan_get['kode']}}" @if($data->kode_laporan==$kodifikasilaporan_get['kode']) selected @endif>[{{$kodifikasilaporan_get['kode']}}] {{$kodifikasilaporan_get['name']}}</option>
													@endforeach
												</select>
												</div>
												...
												<div class="col-lg-9 col-xl-6">
													<select class="form-control" name="kodifikasi" >
														...
														@foreach(kodefikasi_get() as $kodefikasi)
															...
															<option value="{{$kodefikasi['kodifikasi']}}" @if($data->kodifikasi_laporan==$kodefikasi['kodifikasi']) selected @endif>[{{$kodefikasi['kodifikasi']}}] {{$kodefikasi['kategori']}}</option>
														@endforeach
											...
											<div class="form-group row m-b-10" >
												...
												<div class="col-lg-9 col-xl-5">
													<select class="form-control" disabled  name="kodifikasi_rekomendasi" >
														<option value="" >Pilih Kodifikasi</option>';
														@foreach(kodefikasi_get() as $kodefikasi)
															
															<option value="{{$kodefikasi['kodifikasi']}}" @if($data->kodifikasi_rekomendasi==$kodefikasi['kodifikasi']) selected @endif>[{{$kodefikasi['kodifikasi']}}] {{$kodefikasi['kategori']}}</option>
														@endforeach
											...
											<table class="table table-bordered m-b-0">
												<thead>
													<tr>
														...
														<th  class="tth" width="10%">Tingkat</th>
														<th  class="tth" width="15%">Kodifikasi</th>
														<th  class="tth" width="20%">Unit Kerja</th>
													</tr>
												</thead>
												<tbody>
												@foreach(judul_get($data->id) as $no=>$o)
													...
													<tr>
														...
														<td style="vertical-align:top">
															<select name="kodifikasi[{{$o->id}}]" class="form-control" >
																<option value="">Pilih Kodifikasi</option>
																@foreach(kodefikasi_get() as $kodefikasi)
																	
																	<option value="{{$kodefikasi['kodifikasi']}}" @if($kodefikasi['kodifikasi']==$o['kodifikasi']) selected @endif>[{{$kodefikasi['kodifikasi']}}] {{$kodefikasi['kategori']}}</option>
																@endforeach
															
															</select>
														</td>
														<td style="vertical-align:top">{{$o->unitkerja['name']}}</td>
