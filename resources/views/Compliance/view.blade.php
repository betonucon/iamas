					...
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="javascript:;"  class="nav-link active">
								<span class="d-sm-none">COMPLIANCE PROGRAM</span>
								<span class="d-sm-block d-none">COMPLIANCE PROGRAM</span>
							</a>
						</li>
					</ul>
			...
			<div class="modal-dialog" id="modal-sedeng">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="tambah-data" action="{{url('/Compliance')}}" method="post" enctype="multipart/form-data">
							@csrf
			...
			<div class="modal-dialog" id="modal-sedeng">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="tambah-langkah" action="{{url('/Compliance/langkah')}}" method="post" enctype="multipart/form-data">
							@csrf
...
@push('ajax')
	...
	<script>
		...
		function hapus(a){
			$.ajax({
				type: 'GET',
				url: "{{url('Compliance/hapus_pokok')}}",
				data: "id="+a,
				success: function(msg){
					location.reload();
				}
		...
		function hapus_langkah(a){
			$.ajax({
				type: 'GET',
				url: "{{url('Compliance/hapus_langkah')}}",
				data: "id="+a,
				success: function(msg){
					location.reload();
				}
