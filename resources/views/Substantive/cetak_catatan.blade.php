<html>
    <head>
        <title>SUBATANTIVE CATATAN</title>
        <style>
            table{
    ...
    <body>
        <table width="100%">
            ...
            <tr>
                <td class="thd" colspan="2">CATATAN HASIL AUDIT<br>TAHAPAN AUDIT : SUBSTANTIVE</td>
            </tr>
        </table><br>
        <table width="100%">
            <tr>
        ...
        <table width="100%">
            ...
            @foreach(view_substantive_catatan($data->id) as $no=>$desk)
                <tr>
