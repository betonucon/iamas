					...
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="javascript:;"  class="nav-link active">
								<span class="d-sm-none">SUBSTANTIVE CATATAN</span>
								<span class="d-sm-block d-none">SUBSTANTIVE CATATAN</span>
							</a>
						</li>
					</ul>
					<div class="tab-content" style="margin-bottom:0px;padding:1%">
						@if($data->alasan_pengawas_substantive_catatan!="" || $data->alasan_pengawas_substantive_catatan!=null)
							<div class="note note-warning  m-b-15">
								<div class="note-content">
									<h4><b>Note Revisi!</b></h4>
									<p>
										{!!$data->alasan_pengawas_substantive_catatan!!}
									</p>
								</div>
							</div>
						@endif	
...
@push('ajax')
	...
	<script>
		...
		function isi_catatan(a){
			...
			$.ajax({
				type: 'GET',
				url: "{{url('Substantive/Isicatatan')}}",
				data: "id="+a,
				success: function(msg){
		...
		function ubah_data(){
            ...
            var data = new FormData(form);
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{url('/Substantive/proses_catatan')}}",
                    data: data,
                    contentType: false,
                    cache: false,
                    processData:false,
