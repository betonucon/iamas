						...
						<form id="tambah-data" action="{{url('/TiketNew')}}" method="post" enctype="multipart/form-data">
							...
							<div class="tab-content" style="margin-bottom:0px;padding:1%">
								...
								<div class="tab-pane fade active show" id="default-tab-1">
									<div class="col-xl-10 offset-xl-1">
										...
										<div class="form-group row m-b-10" >
											...
											<div class="col-lg-9 col-xl-9">
												<input type="text" class="form-control"  disabled  name="name" value="{{$data->name}}" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
								...
								<div class="tab-pane fade" id="default-tab-2">
									<div class="col-xl-10">
										<div class="form-group row m-b-10" >
											...
											<div class="col-lg-9 col-xl-9">
											<textarea class="textarea form-control"  disabled name="tujuan" id="textareatujuan" placeholder="Enter text ..." rows="8">{!!$data->tujuan!!}</textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="tab-pane fade" id="default-tab-3">
									<div class="col-xl-10">
										<div class="form-group row m-b-10" >
											...
											<div class="col-lg-9 col-xl-9">
												<textarea class="textarea form-control"  disabled name="sasaran" id="textareasasaran" placeholder="Enter text ..." rows="8">{!!$data->sasaran!!}</textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="tab-pane fade" id="default-tab-4">
									<div class="col-xl-10">
										<div class="form-group row m-b-10" >
											...
											<div class="col-lg-9 col-xl-9">
											<textarea class="textarea form-control"  disabled name="risiko" id="textarearisiko" placeholder="Enter text ..." rows="8">{!!$data->risiko!!}</textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="tab-pane fade" id="default-tab-5">
									<div class="col-xl-10 offset-xl-1">
										<div class="form-group row m-b-10" >
											...
											<div class="col-lg-9 col-xl-4">
												<input type="text" class="form-control"  disabled  name="tgl_penerbitan"  value="{{$data->tgl_penerbitan}}" id="tangal_penerbitan" placeholder="Enter text ..." >
											</div>
										</div>
										...
										<div class="form-group row m-b-10" >
											...
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_deskaudit_program_start"  value="{{$data->tgl_deskaudit_program_start}}" id="tgl_deskaudit_program_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_deskaudit_program_end"  value="{{$data->tgl_deskaudit_program_end}}" id="tgl_deskaudit_program_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">(Hasil)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_deskaudit_hasil_start" value="{{$data->tgl_deskaudit_hasil_start}}" id="tgl_deskaudit_hasil_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_deskaudit_hasil_end" value="{{$data->tgl_deskaudit_hasil_end}}" id="tgl_deskaudit_hasil_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">2. Compliance Test (Program)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_compliance_program_start" value="{{$data->tgl_compliance_program_start}}" id="tgl_compliance_program_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_compliance_program_end" value="{{$data->tgl_compliance_program_end}}" id="tgl_compliance_program_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">(Hasil)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_compliance_hasil_start" value="{{$data->tgl_compliance_hasil_start}}" id="tgl_compliance_hasil_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_compliance_hasil_end" value="{{$data->tgl_compliance_hasil_end}}" id="tgl_compliance_hasil_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">3. Substantive (Program)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_substantive_program_start" value="{{$data->tgl_substantive_program_start}}" id="tgl_substantive_program_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_substantive_program_end" value="{{$data->tgl_substantive_program_end}}" id="tgl_substantive_program_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">(Hasil)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_substantive_hasil_start" value="{{$data->tgl_substantive_hasil_start}}" id="tgl_substantive_hasil_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_substantive_hasil_end" value="{{$data->tgl_substantive_hasil_end}}" id="tgl_substantive_hasil_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">(Penyusunan LHA)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_lha_start" value="{{$data->tgl_lha_start}}" id="tgl_lha_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_lha_end" value="{{$data->tgl_lha_end}}" id="tgl_lha_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">4. Reporting Audit (Draft)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_lha_draf_start" value="{{$data->tgl_lha_draf_start}}" id="tgl_lha_draf_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_lha_draf_end" value="{{$data->tgl_lha_draf_end}}" id="tgl_lha_draf_end" placeholder="Enter text ..." >
											</div>
										</div>
										<div class="form-group row m-b-10" >
											<label class="col-lg-3 text-lg-right col-form-label">(Penyelesaian)</label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled  name="tgl_lha_finis_start" value="{{$data->tgl_lha_finis_start}}" id="tgl_lha_finis_start" placeholder="Enter text ..." >
											</div>
											<div class="col-lg-9 col-xl-3">
												<input type="text" class="form-control"  disabled   name="tgl_lha_finis_end" value="{{$data->tgl_lha_finis_end}}" id="tgl_lha_finis_end" placeholder="Enter text ..." >
											</div>
										</div>
								...
								<div class="modal-footer">
									...
									<a href="javascript:;" class="btn btn-white" onclick="sebelumnya()">Tutup</a>
								</div>
		...
		function tambah_data(){
            var form=document.getElementById('tambah-data');
                ...
                $.ajax({
                    ...
                    success: function(msg){
                        if(msg=='ok'){
                            location.assign("{{url('/AccAuditplan')}}");
