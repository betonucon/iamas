...
class LhaController extends Controller
{
    ...
    public function view_head(request $request){
        ...
        if($request->aksi==''){
            ...
            return view('LHA.view_lha_rekomendasi',compact('menu','side','id','kesimpulan_id','nomor'));
        }
    ...
    public function createrekomendasi(request $request){
        ...
        if(akses_tiket_ketua()>0 || akses_tiket_anggota()>0){
                if($data->sts_lha=='0'){
                    ...
                    $side="auditpengawas";
                    return view('LHA.createrekomendasi',compact('menu','side','id','kesimpulan_id','nomor','act'));
                }else{
                    if($data->sts_revisi_lha_saran=='2'){
                        ...
                        $side="auditpengawas";
                        return view('LHA.view_rekomendasi',compact('menu','side','id','kesimpulan_id','nomor'));
                    }
